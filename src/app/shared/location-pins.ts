...
export interface recordsType {
      ...
      floorplans: Array<{ bedrooms: number, type: string, price: number }>,
      highValueAmenities: Array<string>,
      paidUtilities: Array<string>,
      geocode: geocodeType
}
...
export const LOCATION_PINS: APIResponse = {
      agentInfo: {
            accountID: 2360,
            firstname: "Cindy",
            lastname: "Little",
